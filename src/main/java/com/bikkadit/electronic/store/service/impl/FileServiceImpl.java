...
public class FileServiceImpl implements FileServiceI {
    ...
    //user profile Image Implementation
...
//Product Image Implementation
    ...
    public String uploadProductImage(MultipartFile file, String path) throws IOException {
        log.info(" Request Starting for  upload productImage  ");
    ...
    @Override
    public InputStream getProductImage(String path, String name) throws FileNotFoundException {

        log.info(" Request Starting to serve productImage ");
        String fullPath = path + File.separator + name;
        InputStream inputStream = new FileInputStream(fullPath);
        return inputStream;
